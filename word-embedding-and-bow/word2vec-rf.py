...
class Word2VecVectorizer:
    def __init__(self):
        ...
        self.word_vectors = KeyedVectors.load_word2vec_format(
            "/data/zhendi/nlp/pubmed2018_w2v_200D/pubmed2018_w2v_200D.bin", binary=True
        )
...
# pd.to_pickle(trainDf, "/home/zhendi/pm/scripts/Onehot_w2v200_trainDf.pkl")
# pd.to_pickle(trainDf, "/home/zhendi/pm/scripts/Onehot_w2v400_trainDf.pkl")
# trainDf = pd.read_pickle("/home/zhendi/pm/scripts/Onehot_w2v200_trainDf.pkl")
# trainDf = pd.read_pickle("/home/zhendi/pm/scripts/Onehot_w2v400_trainDf.pkl")
...
def evaluate_features(X, y, clf=None):
    ...
    print("f1_score: {}".format(f1_score(y, preds, average="micro")))
